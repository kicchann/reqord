...
2. ProjectContext充実    — product.md, technical.md を記述
...
AIの出力品質は入力の質に比例する。ProjectContextの4つのファイルを充実させることが最も効果的:

| ファイル | 内容 | AIへの影響 |
|---------|------|-----------|
| `product.md` | ビジョン、課題、ターゲットユーザー | 要件の妥当性判断に使われる |
| `technical.md` | 技術スタック、アーキテクチャ | 仕様設計の品質に直結 |
